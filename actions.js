...
function _runServerless(options, callback) {
    ...
    var sls = spawn('serverless', cmd, spawnOptions);
...
/* Init Functions */
module.exports.init = function(name, email, stage, region, callback){
  var options = {'component': 'project',
                 'action': 'init',
                 'name': name,
                 'email': email,
                 'stage': stage,
...
module.exports.testDeployed = function(stage, region, callback){
  var options = {'component': 'function',
                 'action': 'run',
                 'stage': stage,
                 'region': region};
  _runServerless(options, callback);
...
module.exports.deployLambdaResources = function(stage, region, callback){
  var options = {'component': 'resources',
                 'action': 'deploy',
                 'stage': stage,
                 'region': region};
  _runServerless(options, callback);
...
module.exports.deployConfigServiceResources = function(stage, region, callback){
  var options = {'component': 'configServiceResources',
                 'action': 'deploy',
                 'stage': stage,
                 'region': region};
  _runServerless(options, callback);
...
module.exports.deployConfigRuleResources = function(stage, region, callback){
  var options = {'component': 'configRuleResources',
                 'action': 'deploy',
                 'stage': stage,
                 'region': region};
  _runServerless(options, callback);
